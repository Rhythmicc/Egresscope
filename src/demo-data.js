...
const connectionSeeds = [
  ["c1", "workstation", "192.168.1.20", "github.com", "140.82.114.4", 443, "tcp", "GitHub", ["节点选择", "美国", "美国最佳", "us-lax-03"], 512000, 5200000, "00:12:47"],
  ["c2", "workstation", "192.168.1.20", "dl.google.com", "142.250.72.142", 443, "tcp", "Google 直连", ["节点选择", "美国", "美国最佳", "us-lax-03"], 1300000, 18700000, "00:03:21"],
  ["c3", "nas-storage", "192.168.1.10", "s3.us-west-2.amazonaws.com", "52.92.28.23", 443, "tcp", "AWS S3", ["节点选择", "美国", "美国均衡", "us-sea-01"], 8600000, 82300000, "02:14:33"],
  ["c4", "tv-livingroom", "192.168.1.30", "api.netflix.com", "52.16.163.170", 443, "tcp", "Netflix", ["节点选择", "香港", "香港最佳", "hk-hkg-01"], 256000, 12100000, "01:07:58"],
  ["c5", "phone", "192.168.1.40", "appleid.apple.com", "17.253.144.10", 443, "tcp", "Apple 服务", ["节点选择", "美国", "美国均衡", "us-sjc-02"], 320000, 1600000, "00:08:14"],
  ["c6", "gaming-pc", "192.168.1.50", "steamcommunity.com", "146.66.152.18", 443, "tcp", "Steam 社区", ["节点选择", "美国", "美国均衡", "us-sea-01"], 640000, 6800000, "00:16:22"],
  ["c7", "nas-storage", "192.168.1.10", "registry-1.docker.io", "54.198.86.24", 443, "tcp", "Docker", ["节点选择", "美国", "美国最佳", "us-lax-03"], 980000, 14800000, "00:04:51"],
  ["c8", "tablet", "192.168.1.60", "www.youtube.com", "142.250.72.206", 443, "udp", "YouTube", ["节点选择", "日本", "日本最佳", "jp-nrt-01"], 760000, 21600000, "00:21:08"],
];
...
export const demoDashboard = {
  ...
  devices: [
    { name: "nas-storage", ip: "192.168.1.10", active: 84, up: 8_600_000, down: 82_300_000, total: 122 * 1024 ** 3 },
    { name: "workstation", ip: "192.168.1.20", active: 26, up: 1_860_000, down: 23_900_000, total: 64.8 * 1024 ** 3 },
    { name: "tv-livingroom", ip: "192.168.1.30", active: 18, up: 256_000, down: 12_100_000, total: 38.2 * 1024 ** 3 },
    { name: "tablet", ip: "192.168.1.60", active: 15, up: 760_000, down: 21_600_000, total: 25.1 * 1024 ** 3 },
    { name: "gaming-pc", ip: "192.168.1.50", active: 21, up: 640_000, down: 6_800_000, total: 18.4 * 1024 ** 3 },
  ],
  chains: [
...
const demoManualNodes = [
  ...
  "🇺🇸 [移动] 美国西雅图 国际专线",
  "🇨🇦 [电信] 加拿大温哥华 国际专线",
].map((name, index) => ({ id: index === 0 ? "DIRECT" : `demo-manual-${index}`, name }));
...
export const demoStrategies = {
  primary: [
    ...
    { id: "手动选择", name: "手动选择", type: "Selector", typeLabel: "手动指定", modeLabel: "手动选择", selectable: true, now: "DIRECT", nowId: "DIRECT", members: demoManualNodes, delay: "184 ms", delayLevel: "good", children: [] },
...
export const demoDevice = {
  name: "workstation", ip: "192.168.1.20", vendor: "Example", active: 26, up: 1_860_000, down: 23_900_000,
  ...
  flow: {
    nodes: ["workstation", "Google 直连", "GitHub", "漏网之鱼", "节点选择", "美国", "美国最佳", "美国均衡", "us-lax-03", "us-sjc-02", "DIRECT"].map(name => ({ name })),
    links: [
